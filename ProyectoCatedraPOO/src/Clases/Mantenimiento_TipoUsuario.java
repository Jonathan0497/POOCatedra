...
public class Mantenimiento_TipoUsuario {
    ...
    public Mantenimiento_TipoUsuario() {
    ...
    public int obtenerUltimoID() {
        int ultimoID = -1;
        try {
            String sql = "SELECT MAX(id_tipoUsuario) FROM tipo_usuario";
    ...
    public boolean guardarProyecto(){
        ...
        try{
            ...
            String sql = "INSERT INTO tipo_usuario (id_tipoUsuario, tipoUsuario)"
                    + "VALUES(?, ?)";
    ...
    public boolean modificarProyecto(){
        boolean resp = false;
        try {
            String sql = "UPDATE tipo_usuario SET tipoUsuario = ? WHERE id_tipoUsuario = ?;";
            PreparedStatement cmd = cn.prepareStatement(sql);
    ...
    public void llenartabla(javax.swing.JTable tabla) throws Exception {
        try {
            ...
            ps = cn.prepareStatement("SELECT * FROM tipo_usuario");
            rs = ps.executeQuery();
            rsm = rs.getMetaData();
