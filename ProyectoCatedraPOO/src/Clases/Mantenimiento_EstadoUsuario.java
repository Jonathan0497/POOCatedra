...
public class Mantenimiento_EstadoUsuario {
    /**
     * @return the cn
     */
    ...
    public Mantenimiento_EstadoUsuario() {
    ...
    public int obtenerUltimoID() {
        int ultimoID = -1;
        try {
            String sql = "SELECT MAX(id_estadoUsuario) FROM estado_usuario";
    ...
    public boolean guardarProyecto(){
        ...
        try{
            ...
            String sql = "INSERT INTO estado_usuario (id_estadoUsuario, estadoUsuario)"
                    + "VALUES(?, ?)";
    ...
    public boolean modificarProyecto(){
        boolean resp = false;
        try {
            String sql = "UPDATE estado_usuario SET estadoUsuario = ? WHERE id_estadoUsuario = ?;";
            PreparedStatement cmd = cn.prepareStatement(sql);
    ...
    public boolean eliminarProyecto(){
        boolean resp = false;
        try{
            String sql = "DELETE FROM estado_usuario WHERE id_estadoUsuario = ?;";
            PreparedStatement cmd = cn.prepareStatement (sql);
    ...
    public void llenartabla(javax.swing.JTable tabla) throws Exception {
        try {
            ...
            ps = cn.prepareStatement("SELECT * FROM estadoUsuario");
            rs = ps.executeQuery();
            rsm = rs.getMetaData();
